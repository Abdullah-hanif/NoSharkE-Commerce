...
export const ProfileScreen2: FC<StackScreenProps<NavigatorParamList, "SellerProfile">> = observer(
  ({ navigation }) => {
      ...
      <View testID="ShipScreen" style={FULL}>
        ...
        <Screen preset="scroll" backgroundColor={color.transparent}>
          ...
          <View style={CONTAINER}> 
            <View style={x}>
              <Text style={{...TITLE, ...TITLE_WRAPPER}} text="Seller Information" />
            </View>
